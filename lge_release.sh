...
sleep 5
	sh bam-build.sh mako true
		...
		scp out/target/product/mako/jellybam*.zip root@5.9.120.101:/home/Jellybam/upload/
...
sleep 5
        sh bam-build.sh p760 true
                ...
                scp out/target/product/p760/jellybam*.zip root@5.9.120.101:/home/Jellybam/upload/
...
sleep 5
	sh bam-build.sh p920 true
		...
		scp out/target/product/p920/jellybam*.zip root@5.9.120.101:/home/Jellybam/upload/
...
sleep 5
	sh bam-build.sh p930 true
		...
		scp out/target/product/p930/jellybam*.zip root@5.9.120.101:/home/Jellybam/upload/
...
sleep 5
	sh bam-build.sh p970 true
		...
		scp out/target/product/p970/jellybam*.zip root@5.9.120.101:/home/Jellybam/upload/
...
sleep 5
	sh bam-build.sh p990 true
		...
		scp out/target/product/p990/jellybam*.zip root@5.9.120.101:/home/Jellybam/upload/
...
sleep 5
        sh bam-build.sh su640 true
                ...
                scp out/target/product/su640/jellybam*.zip root@5.9.120.101:/home/Jellybam/upload/
