...
# get current version
MAJOR=$(cat $DIR/vendor/jellybam/config/jellybam_common.mk | grep 'BAM_VERSION_MAJOR = *' | sed  's/BAM_VERSION_MAJOR = //g')
MINOR=$(cat $DIR/vendor/jellybam/config/jellybam_common.mk | grep 'BAM_VERSION_MINOR = *' | sed  's/BAM_VERSION_MINOR = //g')
MAINTENANCE=$(cat $DIR/vendor/jellybam/config/jellybam_common.mk | grep 'BAM_VERSION_MAINTENANCE = *' | sed  's/BAM_VERSION_MAINTENANCE = //g')
...
rm -f out/target/product/*/jellybam_*-ota-eng.*.zip
