...
sleep 5
        sh bam-build.sh true  fascinatemtd
...
sleep 5
        sh bam-build.sh true  galaxysmtd
...
sleep 5
        sh bam-build.sh true  mesmerizemtd
...
sleep 5
        sh bam-build.sh true  quincyatt
...
sleep 5
        sh bam-build.sh true  skyrocket
...
sleep 5
        sh bam-build.sh true  vibrantmtd
